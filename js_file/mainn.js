...
const mainSwiper = new Swiper('.swiper-main', {
    loop: true,
    spaceBetween: 0, // تلاصق الصور
    effect: 'slide', // تأثير انتقال سلس
    speed: 600, // سرعة الانتقال
    autoplay: {
        delay: 5000, // 5 ثوانٍ بين كل شريحة
    ...
    touchRatio: 1, // تفعيل السحب (Swipe)
    simulateTouch: true, // دعم اللمس على جميع الأجهزة
    on: {
        click: function () {
            // منع أي إخفاء غير مقصود عند النقر
            return false;
        },
        init: function () {
            // التأكد من تحميل الصور عند التهيئة
